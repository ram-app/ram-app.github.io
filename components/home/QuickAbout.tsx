...
export function QuickAbout() {
  const statsData = [
    { value: "3+", label: "Years Web & Mobile", icon: "ri-time-line", color: "from-blue-500 to-purple-500" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              I'm a passionate Frontend Developer with 3 years of hands-on frontend experience across web and mobile, building responsive applications. 
